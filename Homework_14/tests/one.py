...
def test_create_team():
    ...
    team = Team("Team A", Top5ScoringStrategy(), SixthRunnerTieBreakerStrategy())
...
def test_calculate_winner():
    ...
    team_b = Team("Team B", Top5ScoringStrategy(), SixthRunnerTieBreakerStrategy())
    team_a.score = 25
    team_b.score = 30
    results = Results()
...
def test_empty_team_names():
    ...
    with pytest.raises(ValueError):
        team_a = Team(" ", Top5ScoringStrategy(), SixthRunnerTieBreakerStrategy())

    with pytest.raises(ValueError):
        team_b = Team(" ", Top5ScoringStrategy(), SixthRunnerTieBreakerStrategy())
